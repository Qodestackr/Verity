	...
	return (
		<Card className="shadow-sm">
			...
			<CardContent className="space-y-4 pt-0">
				...
				{!session?.user.emailVerified && (
					<div className="space-y-2">
						<Alert className="py-3">
							<AlertTitle className="text-sm font-medium">Verify Your Email Address</AlertTitle>
				...
				<div className="border-l-2 px-2 py-1 space-y-2">
							...
							return (
								<div key={session.id} className="flex items-center justify-between">
									<div className="flex items-center gap-2 text-xs">
										{isMobile ? <Phone size={14} /> : <Laptop size={14} />}
										<span>
											{os}, {browser}
										</span>
									</div>
				...
				<div className="border-t border-b py-3 flex items-center flex-wrap justify-between">
...
function EditUserDialog() {
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button size="sm" className="gap-1.5 h-8" variant="secondary">
					<Edit size={12} />
