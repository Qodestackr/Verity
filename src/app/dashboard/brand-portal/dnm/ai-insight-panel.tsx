...
export function AIInsightPanel({
    ...
    const insights = [
        ...
        },
        {
            ...
            description:
                "Highland Distributors in Nakuru is showing low stock levels (68%) while experiencing increased demand. Recommend increasing next shipment by 25% to prevent stockouts.",
            impact: "Risk: Potential lost sales of KES 180,000 if not addressed.",
            severity: "warning",
            action: "View Inventory Details",
        },
        {
            id: 3,
            title: "Retailer Growth Opportunity",
            description:
                "Urban Liquor Mart in Nairobi has 35% growth potential with expanded product range. Current performance is good but could be significantly improved with premium product placement.",
            impact: "Opportunity: Increase monthly sales by KES 112,000.",
            severity: "opportunity",
            action: "Create Growth Plan",
        },
    ]
